(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("fs"), require("path"), require("http"), require("https"), require("url"), require("assert"), require("stream"), require("tty"), require("util"), require("net"), require("zlib"), require("os"));
	else if(typeof define === 'function' && define.amd)
		define(["fs", "path", "http", "https", "url", "assert", "stream", "tty", "util", "net", "zlib", "os"], factory);
	else if(typeof exports === 'object')
		exports["AppManager"] = factory(require("fs"), require("path"), require("http"), require("https"), require("url"), require("assert"), require("stream"), require("tty"), require("util"), require("net"), require("zlib"), require("os"));
	else
		root["AppManager"] = factory(root["fs"], root["path"], root["http"], root["https"], root["url"], root["assert"], root["stream"], root["tty"], root["util"], root["net"], root["zlib"], root["os"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_25__, __WEBPACK_EXTERNAL_MODULE_31__, __WEBPACK_EXTERNAL_MODULE_52__, __WEBPACK_EXTERNAL_MODULE_53__, __WEBPACK_EXTERNAL_MODULE_55__, __WEBPACK_EXTERNAL_MODULE_99__, __WEBPACK_EXTERNAL_MODULE_100__, __WEBPACK_EXTERNAL_MODULE_105__, __WEBPACK_EXTERNAL_MODULE_106__, __WEBPACK_EXTERNAL_MODULE_107__, __WEBPACK_EXTERNAL_MODULE_108__, __WEBPACK_EXTERNAL_MODULE_181__) {
...
var AbstractEntity = function () {
    ...
    (0, _createClass3.default)(AbstractEntity, [{
        key: 'getConfigs',
        value: function getConfigs() {
            var _this = this;

            if (this.configs) {
                return _promise2.default.resolve(this.configs);
            }
            return this.api.get('' + this.entityCollectionPath + this.entityId + '/configs').then(function (response) {
                if (response.status === 200 && response.data && response.data._embedded && response.data._embedded.data) {
                    ...
                    return _promise2.default.resolve(_this.configs);
                } else {
                    return _promise2.default.reject(new _Exceptions.UnexpectedApiResponseError());
                }
        ...
        value: function getConfig(configId) {
            return this.getConfigs().then(function (configs) {
                if (configs[configId]) {
                    return _promise2.default.resolve(configs[configId]);
                } else {
                    return _promise2.default.reject(new _Exceptions.ConfigKeyUnknownError('Config-Key \'' + configId + '\' does not exist in Entity.'));
                }
            });
        }
    }, {
...
var _ExtendableError = __webpack_require__(14);
...
var _EntityUnknownError = __webpack_require__(146);
...
var _MissingArgumentError = __webpack_require__(74);
...
var _NotImplementedError = __webpack_require__(147);
...
var _UnexpectedApiResponseError = __webpack_require__(148);
...
var _ConfigKeyUnknownError = __webpack_require__(149);
...
var _ApiKeyUnauthorizedError = __webpack_require__(150);
...
var _ExtendableError2 = __webpack_require__(14);
...
var MissingArgumentError = function (_ExtendableError) {
    (0, _inherits3.default)(MissingArgumentError, _ExtendableError);

    function MissingArgumentError(message) {
        (0, _classCallCheck3.default)(this, MissingArgumentError);

        var _this = (0, _possibleConstructorReturn3.default)(this, (MissingArgumentError.__proto__ || (0, _getPrototypeOf2.default)(MissingArgumentError)).call(this));
...
var eol = __webpack_require__(181).EOL,
  fs = __webpack_require__(25),
  pkg = __webpack_require__(81),
  mkdir = __webpack_require__(182),
...
exports.CSSPreprocessor = undefined;

var _AppManager = __webpack_require__(83);

var _AppManager2 = _interopRequireDefault(_AppManager);

var _CSSPreprocessor = __webpack_require__(169);

var _CSSPreprocessor2 = _interopRequireDefault(_CSSPreprocessor);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _AppManager2.default;
exports.CSSPreprocessor = _CSSPreprocessor2.default;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(20)(Function.call, __webpack_require__(72).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var EntityUnknownError = function (_ExtendableError) {
    (0, _inherits3.default)(EntityUnknownError, _ExtendableError);

    function EntityUnknownError(message) {
        (0, _classCallCheck3.default)(this, EntityUnknownError);

        var _this = (0, _possibleConstructorReturn3.default)(this, (EntityUnknownError.__proto__ || (0, _getPrototypeOf2.default)(EntityUnknownError)).call(this));
...
var NotImplementedError = function (_ExtendableError) {
    ...
    function NotImplementedError(message) {
        ...
        var _this = (0, _possibleConstructorReturn3.default)(this, (NotImplementedError.__proto__ || (0, _getPrototypeOf2.default)(NotImplementedError)).call(this));
...
var UnexpectedApiResponseError = function (_ExtendableError) {
    (0, _inherits3.default)(UnexpectedApiResponseError, _ExtendableError);

    function UnexpectedApiResponseError(message) {
        (0, _classCallCheck3.default)(this, UnexpectedApiResponseError);

        var _this = (0, _possibleConstructorReturn3.default)(this, (UnexpectedApiResponseError.__proto__ || (0, _getPrototypeOf2.default)(UnexpectedApiResponseError)).call(this));
...
var ConfigKeyUnknownError = function (_ExtendableError) {
    (0, _inherits3.default)(ConfigKeyUnknownError, _ExtendableError);

    function ConfigKeyUnknownError(message) {
        (0, _classCallCheck3.default)(this, ConfigKeyUnknownError);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ConfigKeyUnknownError.__proto__ || (0, _getPrototypeOf2.default)(ConfigKeyUnknownError)).call(this));
...
var ApiKeyUnauthorizedError = function (_ExtendableError) {
    (0, _inherits3.default)(ApiKeyUnauthorizedError, _ExtendableError);

    function ApiKeyUnauthorizedError(message) {
        (0, _classCallCheck3.default)(this, ApiKeyUnauthorizedError);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ApiKeyUnauthorizedError.__proto__ || (0, _getPrototypeOf2.default)(ApiKeyUnauthorizedError)).call(this));
...
var _AbstractEntity2 = __webpack_require__(45);
...
var App = function (_AbstractEntity) {
    (0, _inherits3.default)(App, _AbstractEntity);

    function App(appId) {
        (0, _classCallCheck3.default)(this, App);

        var _this = (0, _possibleConstructorReturn3.default)(this, (App.__proto__ || (0, _getPrototypeOf2.default)(App)).call(this, appId, 'apps/', 'App'));
...
var Template = function (_AbstractEntity) {
    (0, _inherits3.default)(Template, _AbstractEntity);

    function Template(templateId) {
        (0, _classCallCheck3.default)(this, Template);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Template.__proto__ || (0, _getPrototypeOf2.default)(Template)).call(this, templateId, 'templates/', 'Template'));
...
var Version = function (_AbstractEntity) {
    (0, _inherits3.default)(Version, _AbstractEntity);

    function Version(versionId) {
        (0, _classCallCheck3.default)(this, Version);

        var _this = (0, _possibleConstructorReturn3.default)(this, (Version.__proto__ || (0, _getPrototypeOf2.default)(Version)).call(this, versionId, 'versions/', 'Version'));
...
var _nodeSass = __webpack_require__(177);
...
var CSSPreprocessor = function () {
    ...
    function CSSPreprocessor() {
        var accessKeyId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
        var secretAccessKey = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
        var region = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'eu-central-1';
        (0, _classCallCheck3.default)(this, CSSPreprocessor);
    ...
    (0, _createClass3.default)(CSSPreprocessor, [{
        key: 'addVariables',
        value: function addVariables(variables) {
            this.variables = (0, _assign2.default)({}, this.variables, variables);
        }
    }, {
        key: 'processVariables',
        value: function processVariables(scss) {
            var _this = this;

            var newScss = scss;
            (0, _keys2.default)(this.variables).forEach(function (varName) {
                var newValue = _this.variables[varName];
                var re = new RegExp('\\$' + varName + '\\s*(?!:)', 'g');
        ...
        key: 'compileSCSS',
        value: function compileSCSS(scss) {
            var processedScss = this.processVariables(scss);

            return _nodeSass2.default.renderSync({
                data: processedScss,
        ...
        key: 'compileSCSSFile',
        value: function compileSCSSFile(file) {
            var _this2 = this;

            var fileContents = _fs2.default.readFileSync(file, 'utf8');
            var processedScss = this.processVariables(fileContents);

            return _nodeSass2.default.renderSync({
                data: processedScss,
                outputStyle: 'compressed',
                includePaths: [_path2.default.dirname(file)],
                importer: function importer(url) {
                    var importedFileContents = _fs2.default.readFileSync(_path2.default.dirname(file) + '/' + url + '.scss', 'utf8');
                    var processedScss = _this2.processVariables(importedFileContents);
...
exports.default = CSSPreprocessor;
...
var path = __webpack_require__(31),
  clonedeep = __webpack_require__(178),
  assign = __webpack_require__(180),
  sass = __webpack_require__(80);

/**
 * Require binding
 */

var binding = __webpack_require__(183)(sass);
...
var errors = __webpack_require__(184);
...
var sass = __webpack_require__(80),
  pkg = __webpack_require__(81);
